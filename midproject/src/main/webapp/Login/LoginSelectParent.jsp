...
<script>
	function addChild() {
	    ...
	    const childInputContainer = document.createElement("div");
	    childInputContainer.className = "child-input-container";
	    const childInput = document.createElement("input");
	    childInput.type = "text";
	    childInput.name = "childname";
	    childInput.className = "text-field";
	    childInput.placeholder = "자녀이름";
	    childInput.style.width = "150px";
	    const removeButton = document.createElement("button");
	    removeButton.type = "button";
	    removeButton.textContent = "삭제";
	    removeButton.onclick = function() {
	        childInfo.removeChild(childInputContainer);
	    };
	    const searchButton = document.createElement("button");
	    searchButton.type = "button";
	    searchButton.textContent = "교사 검색";
	    searchButton.onclick = searchTeacher;
	    childInputContainer.appendChild(childInput);
	    childInputContainer.appendChild(removeButton);
	    childInputContainer.appendChild(searchButton);
	    childInfo.appendChild(childInputContainer);
	}
	function removeChild(container) {
		const childInfo = document.getElementById("child-info");
		childInfo.removeChild(container);
	}
...
<body>
	<div class="login-form">
	    <p>정보를 입력해주세요</p>
	    <form action="../login/SignUp.do" method="post" name="LoginForm" onsubmit="return validateForm()">
			<div id="parent-info">
		        ...
		        <div id="child-info">
					<input type="text" name="childname" class="text-field" placeholder="자녀이름" style="width:150px;"><button type="button" onclick="addChild()">추가</button><button type="button" onclick="searchTeacher()">교사 검색</button>
		        </div>
