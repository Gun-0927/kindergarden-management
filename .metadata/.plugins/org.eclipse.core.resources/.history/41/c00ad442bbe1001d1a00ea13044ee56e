...
<body>
<a href="../../blueproject/Board/Enterance.jsp">메인화면으로 돌아가기</a>
  <h2 style="text-align : center; color: green;">알림장</h2><br><br>
   <!-- 검색 -->
   <form method="get">
      <table  width="100%">
          <tr align="right">
...
<c:choose>
   ...
   <c:otherwise>
      <c:forEach items="${boardList}" var="list" varStatus="stat">
         <tr align="center">
            ...
            <td align="center">
               <a href="../m2board/view2.do?boardnum=${list.boardnum}">${list.title} </a> 
            </td>
            <td>${list.writerid}</td>
            <td>${list.count}</td>
         </tr>
   ...
   <table  width="100%">
      <tr align="center">
         ...
         <td width="100">
          <form action="../blueproject/Board/Write.jsp?boardkind=1" method="post">
